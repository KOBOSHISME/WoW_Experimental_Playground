...
function Diagnostics:HandleSlash(input)
	...
	if args[1] == "pranks" or args[1] == "prank" or args[1] == "interfere" or args[1] == "interference" then
		if WEP.Pranks and WEP.Pranks.HandleSlash then
			WEP.Pranks:HandleSlash(args)
		elseif WEP.PartyInterference and WEP.PartyInterference.HandleSlash then
			WEP.PartyInterference:HandleSlash(args)
		else
			WEP:Print("Pranks feature is unavailable.")
		end
...
function Diagnostics.PrintHelp()
	...
	WEP:Print("/wep pranks - Open Pranks.")
